  ...
  return (
    <>
          ...
          <table className='admin-table'>
            <thead>
              <tr>
                ...
                <th className="delete">
                  <img className="modify" src={deleteButton}></img>
                </th>
              </tr>
              <tr>
                ...
                <th className="modify">
                  <img className="modify" src={modify}></img>
                </th>
                <th className="delete">
                  <img className="modify" src={deleteButton}></img>
                </th>
      ...
      <div
        ...
        style={{ display: isCreateQuestion ? "block" : "none" }}
      >
        <img
          className="xButton"
          src={xButton}
          alt="xButton"
          onClick={handleCancleClik}
        />
        ...
        <div className="questionOneLine">
          ...
          <input className="ctfRadio" type="radio" name="" value="" />
          <h4>객관식</h4>
          <input className="ctfRadio" type="radio" name="" value="" />
          <h4>주관식</h4>
        </div>
      ...
      <div
        className="questionEdit"
        style={{ display: isEditQuestion ? "block" : "none" }}
      >
        <img
          className="xButton"
          src={xButton}
